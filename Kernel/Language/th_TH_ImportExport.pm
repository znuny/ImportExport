...
sub Data {
    ...
    $Self->{Translation}->{'Import/Export Management'}
        = 'การจัดการ นำเข้า/ส่งออก';
    $Self->{Translation}->{'Add template'} = 'เพิ่มแม่แบบ';
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'สร้างแม่แบบเพื่อนำเข้าและส่งออกข้อมูลออบเจกต์';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'No map elements found.'}
        = 'ไม่พบองค์ประกอบแผนที่';
    $Self->{Translation}->{'Add Mapping Element'}
        = 'เพิ่มองค์ประกอบของการทำแผนที่';
    $Self->{Translation}->{'Step 5 of 5 - Edit search information'} = '';
    $Self->{Translation}->{'Restrict export per search'}
        = 'การจำกัดการส่งออกตามการค้นหา';
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'หมายเลขของการประมวลครั้งสุดท้ายของการนำไฟล์เข้า';
    ...
    $Self->{Translation}->{'Import and export object information.'}
        = 'การนำเข้าหรือส่งออกข้อมูลออบเจกต์';
