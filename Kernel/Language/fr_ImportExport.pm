...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Créer un modèle pour importer et exporter les informations d\'objet';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Step 1 of 5 - Edit common information'}
        = 'Étape 1 sur 5 - Éditer les information communes';
    ...
    $Self->{Translation}->{'Step 2 of 5 - Edit object information'}
        = 'Étape 2 sur 5 - Éditer les informations de l\'objet';
    $Self->{Translation}->{'Step 3 of 5 - Edit format information'}
        = 'Étape 3 sur 5 - Éditer les informations du format';
    $Self->{Translation}->{'is required!'} = 'est requis !';
    $Self->{Translation}->{'Step 4 of 5 - Edit mapping information'}
        = 'Étape 4 sur 5 - Éditer les informations de mappage';
    ...
    $Self->{Translation}->{'Step 5 of 5 - Edit search information'}
        = 'Étape 5 sur 5 - Éditer les informations de recherche';
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Numéro de la dernière ligne traitée dans le fichier d\'importation';
    ...
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Une erreur est survenue, importation impossible ! Pour plus de détails, consultez le journal d’événements système.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Une erreur est survenue, exportation impossible ! Pour plus de détails, consultez le journal d’événements système.';
    ...
    $Self->{Translation}->{'Invalid data, please insert a valid %s'}
        = 'Données invalides. Veuillez insérer une %s valide';
