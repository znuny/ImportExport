...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Kreiraj šablon za uvoz i izvoz informacija o objektu.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Broj poslednje obrađene linije uvezene datoteke';
    $Self->{Translation}->{'Ok'} = 'U redu';
    $Self->{Translation}->{'Do you really want to delete this template item?'}
        = 'Da li stvarno želite da obrišete ovaj šablon?';
    ...
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Dogodila se greška. Uvoz je nemoguć! Za detalje pogledajte u sistemski dnevnik.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Dogodila se greška. Izvoz je nemoguć! Za detalje pogledajte u sistemski dnevnik.';
