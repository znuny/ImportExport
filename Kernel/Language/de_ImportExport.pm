...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Erstellen einer Vorlage zum Importieren und Exportieren von Objektinformationen.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Step 1 of 5 - Edit common information'}
        = 'Schritt 1 von 5 - Allgemeine Informationen bearbeiten';
    ...
    $Self->{Translation}->{'Step 2 of 5 - Edit object information'}
        = 'Schritt 2 von 5 - Objektinformationen bearbeiten';
    $Self->{Translation}->{'Step 3 of 5 - Edit format information'}
        = 'Schritt 3 von 5 - Formatinformationen bearbeiten';
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Zuletzt verarbeitete Zeilennummer der Import-Datei';
    $Self->{Translation}->{'Ok'} = 'Ok';
    $Self->{Translation}->{'Do you really want to delete this template item?'}
        = 'Möchten Sie dieses Vorlagenelement wirklich löschen?';
    ...
    $Self->{Translation}->{'Can\'t insert/update template!'}
        = 'Die Vorlage konnte nicht eingefügt oder aktualisiert werden!';
    $Self->{Translation}->{'Needed TemplateID!'} = 'Die ID der Vorlage wird benötigt!';
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Fehler aufgetreten. Importieren unmöglich! Für Details siehe Systemprotokoll.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Fehler aufgetreten. Exportieren unmöglich! Für Details siehe Systemprotokoll.';
    ...
    $Self->{Translation}->{'Invalid data, please insert a valid %s'}
        = 'Ungültige Daten, bitte geben Sie ein gültiges %s ein';
