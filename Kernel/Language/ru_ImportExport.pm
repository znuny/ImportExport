...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Создайте шаблон для импорта и экспорта информации объектов';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Step 1 of 5 - Edit common information'}
        = 'Шаг 1 из 5 — изменить общую информацию';
    ...
    $Self->{Translation}->{'Step 2 of 5 - Edit object information'}
        = 'Шаг 2 из 5 — изменить информацию об объекте';
    $Self->{Translation}->{'Step 3 of 5 - Edit format information'}
        = 'Шаг 3 из 5 — изменить формат информации';
    $Self->{Translation}->{'is required!'} = 'обязателен!';
    $Self->{Translation}->{'Step 4 of 5 - Edit mapping information'}
        = 'Шаг 4 из 5 — изменить информацию о сопоставлении';
    $Self->{Translation}->{'No map elements found.'}
        = 'Элементы для сопоставления не найдены.';
    $Self->{Translation}->{'Add Mapping Element'} = 'Добавьте элемент сопоставления';
    $Self->{Translation}->{'Step 5 of 5 - Edit search information'}
        = 'Шаг 5 из 5 — изменить информацию поиска';
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Номер последней обработанной строки импортируемого файла';
    $Self->{Translation}->{'Ok'} = 'Ok';
    $Self->{Translation}->{'Do you really want to delete this template item?'}
        = 'Действительно удалть этот шаблон?';
    ...
    $Self->{Translation}->{'Can\'t insert/update template!'}
        = 'Невозможно добавить/обновить шаблон!';
    $Self->{Translation}->{'Needed TemplateID!'} = 'Требуется ID Шаблона!';
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Ошибка. Импорт невозможен! Смотри подробности в Syslog.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Ошибка. Экспорт невозможен! Смотри подробности в Syslog.';
    ...
    $Self->{Translation}->{'Element required, please insert data'}
        = 'Обязательные элемент, пожалуйста введите данные.';
    $Self->{Translation}->{'Invalid data, please insert a valid %s'}
        = 'Неверные данные, пожалуйста, укажите верные %s';
    ...
    $Self->{Translation}->{'Import and export object information.'}
        = 'Импорт и экспорт информации об объектах';
