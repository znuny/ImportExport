...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Maak een sjabloon om objectinformatie te importeren en exporteren.';
    $Self->{Translation}->{
        'To use this module, you need to install ITSMConfigurationManagement or any other package that provides backend for objects to be imported and exported.'
        } =
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Laatst verwerkte regelnummer van importbestand';
    $Self->{Translation}->{'Ok'} = 'Ok';
    $Self->{Translation}->{'Do you really want to delete this template item?'}
        = 'Wilt u dit sjabloonitem echt verwijderen?';
    ...
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Fout opgetreden. Import onmogelijk! Zie Syslog voor details.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Fout opgetreden. Export onmogelijk! Zie Syslog voor details.';
