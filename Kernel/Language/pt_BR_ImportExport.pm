...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Criar um modelo para importar e exportar informações de objeto.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Step 4 of 5 - Edit mapping information'}
        = 'Passo 4 de 5 - Editar informações de mapeamento';
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Último número de linha processada do arquivo de imporatação';
    ...
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Ocorreu um erro. Foi impossível realizar a importação! Verifique o Syslog para mais detalhes.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Ocorreu um erro. Foi impossível realizar a exportação! Verifique o Syslog para mais detalhes.';
