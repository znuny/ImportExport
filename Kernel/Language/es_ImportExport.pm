...
sub Data {
    ...
    $Self->{Translation}->{'Create a template to import and export object information.'}
        = 'Crear una plantilla para importar y exportar información de objetos.';
    $Self->{Translation}->{
    ...
    $Self->{Translation}->{'Last processed line number of import file'}
        = 'Último número de línea procesada del archivo a importar';
    ...
    $Self->{Translation}->{'Error occurred. Import impossible! See Syslog for details.'}
        = 'Ha ocurrido un error. ¡Imposible de Importar¡ Revise las trazas del sistema para obtener los detalles.';
    $Self->{Translation}->{'Error occurred. Export impossible! See Syslog for details.'}
        = 'Ha ocurrido un error. ¡Imposible de Exportar¡ Revise las trazas del sistema para obtener los detalles.';
    ...
    $Self->{Translation}->{'Invalid data, please insert a valid %s'}
        = 'Datos inválidos, por favor oeste un %s válido';
